...
<body>
    ...
    <form name="from1" method="post" action="inizia_fase.php">
    <table>
        <tr>
            <th>N°COMMESSA</th>
            <th>N°COLLAUDO</th>
        ...
        for($i=0; $i<count($associazioni_giac_fase); $i++){
            ...
            $old_fase = DAOFactory::getFasiDAO()->load($assoc_giac_fase->idFase);
            echo "<tr>
                    <td> $old_fase->idCommessa </td>
                    <td> $certificato->collN </td>
                    <td> $old_fase->oraInizio </td>
                    <td> &nbsp; </td>
        ...
        <tr>
            <td><input type="hidden" name="id_fase" value="<?php echo $fase->idFase; ?>" /> <?php echo $fase->idCommessa; ?></td>
            <td>&nbsp;</td>
