...
<table>
    ...
    for($i=0; $i<count($depositi); $i++){
        $deposito = $depositi[$i];
        echo "<tr>
                <td>$deposito->idDepositoLastre</td>
                ...
                <td><a href=\"elimina_deposito_lastre.php?id=$deposito->idDepositoLastre\"><img class=\"img\" src=\"img/icon_delete.png\" />Elimina</a></td>
            </tr>";
...
<p><a href="visualizza_lista_depositi.php?data=<?php echo $_GET['data']; ?>">Stampa in pdf</a></p>
